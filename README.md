...
should be compatible with API 21 and beyond.  You will need
...
A complete description of this project including full instructions for building it from scratch may be found by 
going to http://eagle.phys.utk.edu/guidry/android/ and selecting <em>Sharing with Intents</em> from the menu.
